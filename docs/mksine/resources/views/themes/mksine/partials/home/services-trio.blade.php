{{-- Static services grid (phase 1). Copy: mksine::frontend.home_services_* --}}
<section class="home-services-trio bg-violet-50 py-10 md:py-14 lg:py-16 xl:py-20 dark:bg-violet-950/40" aria-labelledby="home-services-trio-heading">
    <div class="mx-auto w-[90%] max-w-[87.5rem]">
        <h2 id="home-services-trio-heading" class="mx-auto mb-10 max-w-4xl text-balance text-center text-2xl font-bold tracking-tight text-gray-900 md:text-3xl lg:mb-14 dark:text-gray-50">
            {{ __('mksine::frontend.home_services_section_title') }}
        </h2>
        <div class="grid grid-cols-1 gap-6 md:gap-8 lg:grid-cols-3 lg:gap-10 xl:mt-8">
            ...
            >
                <img
                    src="{{ theme_asset('images/home-services-hosting.svg') }}"
                    alt="{{ __('mksine::frontend.home_services_hosting_img_alt') }}"
                    width="198"
                    height="205"
                    loading="lazy"
                    decoding="async"
                ...
                <div class="flex flex-1 flex-col items-center gap-6">
                    <h3 class="text-lg font-semibold text-violet-600 md:text-xl dark:text-violet-400">
                        {{ __('mksine::frontend.home_services_hosting_title') }}
                    </h3>
                    <p class="max-w-sm text-pretty text-base text-gray-600 md:text-lg dark:text-gray-300">
                        {{ __('mksine::frontend.home_services_hosting_body') }}
                    </p>
                    <span class="mt-auto inline-flex rounded-md bg-violet-600 px-5 py-2.5 text-sm font-semibold text-white transition group-hover:bg-violet-700 dark:bg-violet-500 dark:group-hover:bg-violet-600">
                        {{ __('mksine::frontend.home_services_hosting_cta') }}
                    </span>
                </div>
            </a>
            <a
            ...
            >
                <img
                    src="{{ theme_asset('images/home-services-email.svg') }}"
                    alt="{{ __('mksine::frontend.home_services_email_img_alt') }}"
                    width="198"
                    height="205"
                    loading="lazy"
                    decoding="async"
                ...
                <div class="flex flex-1 flex-col items-center gap-6">
                    <h3 class="text-lg font-semibold text-violet-600 md:text-xl dark:text-violet-400">
                        {{ __('mksine::frontend.home_services_email_title') }}
                    </h3>
                    <p class="max-w-sm text-pretty text-base text-gray-600 md:text-lg dark:text-gray-300">
                        {{ __('mksine::frontend.home_services_email_body') }}
                    </p>
                    <span class="mt-auto inline-flex rounded-md bg-violet-600 px-5 py-2.5 text-sm font-semibold text-white transition group-hover:bg-violet-700 dark:bg-violet-500 dark:group-hover:bg-violet-600">
                        {{ __('mksine::frontend.home_services_email_cta') }}
                    </span>
                </div>
            </a>
            <a
            ...
            >
                <img
                    src="{{ theme_asset('images/home-services-ssl.svg') }}"
                    alt="{{ __('mksine::frontend.home_services_ssl_img_alt') }}"
                    width="198"
                    height="205"
                    loading="lazy"
                    decoding="async"
                ...
                <div class="flex flex-1 flex-col items-center gap-6">
                    <h3 class="text-lg font-semibold text-violet-600 md:text-xl dark:text-violet-400">
                        {{ __('mksine::frontend.home_services_ssl_title') }}
                    </h3>
                    <p class="max-w-sm text-pretty text-base text-gray-600 md:text-lg dark:text-gray-300">
                        {{ __('mksine::frontend.home_services_ssl_body') }}
                    </p>
                    <span class="mt-auto inline-flex rounded-md bg-violet-600 px-5 py-2.5 text-sm font-semibold text-white transition group-hover:bg-violet-700 dark:bg-violet-500 dark:group-hover:bg-violet-600">
                        {{ __('mksine::frontend.home_services_ssl_cta') }}
                    </span>
                </div>
            </a>
        </div>
